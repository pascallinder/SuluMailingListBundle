...
class NewsletterUnsubscribedEvent extends DomainEvent
{
    ...
    {
        return $this->newsletterSubscription->getContact()->getFirstName() . " NewsletterUnsubscribedEvent.php" .$this->newsletterSubscription->getContact()->getLastName()
            . ' ('. $this->newsletterSubscription->getContact()->getMainEmail(). ')'
            . ' - ' . $this->newsletterSubscription->getNewsletter()->getTitle();
    }
}